    ...
    <div id="home" className="home-page">
      ...
      <section className="hero">
        <div className="hero-overlay">
          ...
          >
            <source src="/chamundi-hero.mp4" type="video/mp4" />
          </video>
        </div>
